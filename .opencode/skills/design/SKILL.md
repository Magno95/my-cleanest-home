...
name: design
description: >
  Design system inspired by Airbnb's website. Focus on visual theme, color palette, typography, component stylings, layout principles, depth/elevation, and responsive behavior. Use Airbnb's pure white canvas with Rausch Red accent, warm near-black text, three-layer shadows, generous border-radius, and photography-first approach as core inspirations. Provide detailed rules and examples for each aspect of the design system.
  Use when user says "design system", "UI guidelines", "inspired by Airbnb", "visual theme", "color palette", "typography rules", "component stylings", "layout principles", "depth and elevation", "responsive behavior", or invokes /design.
---
